...
double poisson_binomial_normal_lpmf(int k,const std::vector<double> & probs, int probslen, std::vector<double> & gradient,std::vector<VariancePopulation> & VarPops,std::vector<double> & hypergradient);
