...
const int Nm = 42; // number of magnitude bins
const int Nt = 3; // number of time bins, coarse, feel free to change
...
const double mut_mag = 0;
const double sigmat_mag = 15;
const double lt_mag = 2;
